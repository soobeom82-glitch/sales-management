...
class VmmsWidgetProvider : AppWidgetProvider() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intent.action == ACTION_REFRESH) {
            WidgetDataStore(context).saveRefreshing(true)
    ...
    companion object {
        const val ACTION_REFRESH = "com.example.vmmswidget.ACTION_REFRESH"
    }
}
